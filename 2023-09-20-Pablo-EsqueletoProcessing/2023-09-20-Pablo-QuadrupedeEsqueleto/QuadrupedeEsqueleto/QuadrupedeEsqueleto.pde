...
void correr(){
  ...
  LfrontZ = LfrontZ + moveLeg*0.7; 
  RfrontZ = RfrontZ + moveLeg;
  LLegFZ = LLegFZ + moveLeg*0.7;
  RLegFZ = RLegFZ + moveLeg;
  
  LrearZ = LrearZ - moveLeg;
  RrearZ = RrearZ - moveLeg*0.7;
  LLegRZ = LLegRZ - moveLeg;
  RLegRZ = RLegRZ - moveLeg*0.7;
